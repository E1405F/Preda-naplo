...
namespace Préda_naplo
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            JegyManager jegyManager = new JegyManager(jegyekFajl, felhasznalok, szuloGyerekKapcsolat);
            ...
            {
                Console.Clear();
                Console.WriteLine("ONLINE NAPLO RENDSZER");
                Console.WriteLine("[1] Bejelentkezes");
                Console.WriteLine("[2] Regisztracio");
                Console.WriteLine("[3] Elfelejtett jelszo");
                ...
                if (valasztas == "1")
                {
                    ...
                    {
                        Console.WriteLine("Udvozollek, " + bejelentkezes.AktualisFelhasznalo.Nev + "!");
                    ...
                    {
                        Console.WriteLine("Bejelentkezes sikertelen!");
                        Console.ReadLine();
                    }
                }
                else if (valasztas == "2")
        ...
        {
            Console.Clear();
            Console.WriteLine("ELFELEJTETT JELSZO");
            ...
            if (felhasznalo == null)
            {
                Console.WriteLine("Nem talalhato ilyen felhasznalo!");
                Console.WriteLine("Nyomj ENTER-t a visszalepeshez...");
                Console.ReadLine();
                return;
            }

            Console.WriteLine("Felhasznalo: " + felhasznalo.Nev);
        ...
        private static void FrissitFelhasznalokFajlt(List<Felhasznalo> felhasznalok, string fajlEleres)
        {
            ...
            {
                Console.WriteLine("Hiba a fajl frissitesekor: " + ex.Message);
            }
        }
    }
}