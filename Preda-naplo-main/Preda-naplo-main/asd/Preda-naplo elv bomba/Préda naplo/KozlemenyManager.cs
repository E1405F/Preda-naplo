...
namespace Préda_naplo
{
    internal class KozlemenyManager
    {
        ...
        public void UjKozlemeny(Felhasznalo felado)
        {
            ...
            {
                Console.WriteLine("Csak tanarok, igazgatok es adminisztratorok irhatnak kozlemenyeket!");
                return;
            }

            Console.WriteLine("UJ KOZLEMENY");
            Console.Write("Cim: ");
            ...
            Console.WriteLine("Kozlemeny sikeresen elkuldve " + felhasznalok.Count + " felhasznalonak!");
        }

        public void KozlemenyekListazasa(Felhasznalo felhasznalo)
        {
            Console.WriteLine("KOZLEMENYEK");
            ...
            {
                Console.WriteLine("Nincsenek kozlemenyek.");
                return;
            }
    ...
    internal class Kozlemeny
    {
        ...
        {
            return Cim + "\n" + Tartalom + "\n\nFelado: " + FeladoFelhasznalonev + " - " + Datum.ToString("yyyy.MM.dd HH:mm");
        }

        public string ToFileFormat()
        {
            return FeladoFelhasznalonev + ";" + Cim + ";" + Tartalom + ";" + Datum.ToString("yyyy.MM.dd HH:mm") + ";" + CelzettFelhasznalonev;
        }
