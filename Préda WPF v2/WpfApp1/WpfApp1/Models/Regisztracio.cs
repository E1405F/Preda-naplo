...
namespace WpfApp1.Models
{
    internal class Regisztracio
    {
        ...
        public void UjFelhasznalo()
        {
            ...
            do
            {
                ...
                switch (szerepValasz)
                {
                    case "1":
                        ...
                        tantargyak = BeolvasTantargyak("diák");
                        helyes = true;
                    ...
                    case "2":
                        ...
                        tantargyak = BeolvasTantargyak("tanár");
                        helyes = true;
                        break;
                    case "3":
                        szerep = "Szülő";
            ...
            // Mentés a fájlba tantárgyakkal együtt
            if ((szerep == "Tanár" || szerep == "Diák") && (uj is Tanar tanarObj || uj is Diak diakObj))
            {
                string tantargyakString = string.Join(",", tantargyak);
                File.AppendAllText(fajlEleres, $"{felh};{jelszo};{nev};{iskola};{szerep};{osztaly};{tantargyakString}" + Environment.NewLine);
            }
            else
            {
            ...
            if ((szerep == "Tanár" || szerep == "Diák") && tantargyak.Any())
            {
                Console.WriteLine($"Tantárgyak: {string.Join(", ", tantargyak)}");
            }
        ...
        public bool UjFelhasznalo(string felhasznalonev, string jelszo, string nev, string iskolaNev,
            string szerepkor, string osztaly, string gyerekFelhasznalonev, List<string> tantargyak = null)
        {
            ...
            {
                string tantargyakString = string.Join(",", tantargyak);
                File.AppendAllText(fajlEleres, $"{felhasznalonev};{jelszo};{nev};{iskolaNev};{szerepkor};{osztaly};{tantargyakString}" + Environment.NewLine);
            }
            else
            {
                File.AppendAllText(fajlEleres, uj.ToFileFormat() + Environment.NewLine);
