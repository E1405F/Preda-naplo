...
namespace PredaNaplo
{
    public partial class MainWindow : Window
    {
        ...
        private void ShowRegistrationDialog()
        {
            ...
            var schoolBox = new TextBox { Style = GetStyle("ModernTextBox") };
            ...
            var classBox = new TextBox { Style = GetStyle("ModernTextBox") };
            ...
            {
                if (roleCombo.SelectedItem?.ToString() == "Tanár")
                {
        ...
        private void ShowJustifyAbsenceDialog()
        {
            ...
            // Diák választása legördülő listából (ha tanár vagy igazgató)
            if (aktualisFelhasznalo?.Szerepkor == "Tanár" || aktualisFelhasznalo?.Szerepkor == "Igazgató")
            {
                ...
                var listBox = new ListBox { Style = GetStyle("ModernListBox"), Height = 200, DisplayMemberPath = "DisplayText", Margin = new Thickness(0, 10, 0, 0) };
                stack.Children.Add(listBox);

                // Eseménykezelő a diák kiválasztásra
                ...
                // Triggereljük az első kiválasztást
                if (diakCombo.Items.Count > 0)
                    diakCombo.SelectedIndex = 0;
            ...
            {
                // Szülő esetén marad az eredeti logika
                var gyerek = GetGyermek(aktualisFelhasznalo);
                if (gyerek == null)
                {
                    stack.Children.Add(new TextBlock
